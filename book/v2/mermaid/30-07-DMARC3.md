...
sequenceDiagram
    ...
    participant smtp   as dkim.smtp.x.test<br>10.255.24.21
    ...
    mx      ->> mx     : SPFは 10.255.1.20/31 送信元は 10.255.24.21<br>Authentication-Results SPF=fail
    rect rgb(244, 244, 244)
    ...
    rect rgb(244, 244, 244)
     ...
     mx      ->> mx    : a.test にStrict設定無し<br>a.testのDMARCの内容をpass.dkim.a.testに適用<br>SPF=fail SPFアライメントNG<br>ヘッダーFromとd=が一致 DKIM=pass DKIMアライメントOK<br>Authentication-Results DMARC=pass
    mx      ->> imap   : SMTP
```
